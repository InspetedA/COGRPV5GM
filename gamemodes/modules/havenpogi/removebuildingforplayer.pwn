    // REMOVE GAS PUMPS
    RemoveBuildingForPlayer(playerid, 1686, 655.664, -569.601, 15.359, 0.250); // LS LOC
    RemoveBuildingForPlayer(playerid, 1686, 655.664, -571.210, 15.359, 0.250); // LS LOC
    RemoveBuildingForPlayer(playerid, 1686, 655.664, -558.929, 15.359, 0.250); // LS LOC
    RemoveBuildingForPlayer(playerid, 1686, 655.664, -560.546, 15.359, 0.250); // LS LOC
    RemoveBuildingForPlayer(playerid, 1676, 1941.660, -1767.290, 14.140, 0.250); // LS LOC
    RemoveBuildingForPlayer(playerid, 1676, 1941.660, -1771.339, 14.140, 0.250); // LS LOC
    RemoveBuildingForPlayer(playerid, 1676, 1941.660, -1774.310, 14.140, 0.250); // LS LOC
    RemoveBuildingForPlayer(playerid, 1676, 1941.660, -1778.449, 14.140, 0.250); // LS LOC
    ...
    // Race Track
    RemoveBuildingForPlayer(playerid, 1408, 800.2109, -1715.4375, 13.1016, 0.25);
    ...
    // DILIMORE MECH BY HYDRAX / HAVEN
    RemoveBuildingForPlayer(playerid, 1345, 693.289, -456.015, 16.007, 0.250);
    ...
    // Hp Exterior
    RemoveBuildingForPlayer(playerid, 759, 1630.099, 1856.270, 10.031, 0.250);
    RemoveBuildingForPlayer(playerid, 759, 1584.550, 1856.270, 10.031, 0.250);
    RemoveBuildingForPlayer(playerid, 621, 1580.380, 1821.380, 9.546, 0.250);
    RemoveBuildingForPlayer(playerid, 620, 1580.400, 1845.290, 9.554, 0.250);
    RemoveBuildingForPlayer(playerid, 620, 1597.630, 1862.680, 9.554, 0.250);
    RemoveBuildingForPlayer(playerid, 620, 1617.410, 1862.680, 9.554, 0.250);
    RemoveBuildingForPlayer(playerid, 621, 1634.180, 1858.339, 9.554, 0.250);
    RemoveBuildingForPlayer(playerid, 620, 1635.979, 1845.349, 9.554, 0.250);
    RemoveBuildingForPlayer(playerid, 640, 1632.989, 1782.380, 10.617, 0.250);
    RemoveBuildingForPlayer(playerid, 640, 1632.989, 1754.050, 10.617, 0.250);
    RemoveBuildingForPlayer(playerid, 620, 1633.130, 1724.959, 9.554, 0.250);
    RemoveBuildingForPlayer(playerid, 621, 1581.510, 1726.709, 9.585, 0.250);
    RemoveBuildingForPlayer(playerid, 640, 1598.979, 1723.520, 10.515, 0.250);
    RemoveBuildingForPlayer(playerid, 640, 1581.900, 1753.229, 10.515, 0.250);
    RemoveBuildingForPlayer(playerid, 1215, 1577.589, 1748.030, 10.375, 0.250);
    RemoveBuildingForPlayer(playerid, 640, 1581.900, 1782.420, 10.515, 0.250);
    RemoveBuildingForPlayer(playerid, 1215, 1577.589, 1778.380, 10.375, 0.250);
    RemoveBuildingForPlayer(playerid, 640, 1586.829, 1810.020, 10.507, 0.250);
    RemoveBuildingForPlayer(playerid, 1420, 1589.199, 1814.520, 9.812, 0.250);
    RemoveBuildingForPlayer(playerid, 640, 1597.420, 1835.479, 10.617, 0.250);
    RemoveBuildingForPlayer(playerid, 1215, 1594.189, 1835.510, 10.382, 0.250);
    RemoveBuildingForPlayer(playerid, 1215, 1600.550, 1835.510, 10.382, 0.250);
    RemoveBuildingForPlayer(playerid, 1215, 1605.310, 1835.510, 10.382, 0.250);
    RemoveBuildingForPlayer(playerid, 1215, 1610.060, 1835.510, 10.382, 0.250);
    RemoveBuildingForPlayer(playerid, 640, 1613.290, 1835.479, 10.617, 0.250);
    RemoveBuildingForPlayer(playerid, 1215, 1616.420, 1835.510, 10.382, 0.250);
    RemoveBuildingForPlayer(playerid, 640, 1620.479, 1816.839, 10.617, 0.250);
    RemoveBuildingForPlayer(playerid, 628, 1597.439, 1817.530, 11.492, 0.250);
    RemoveBuildingForPlayer(playerid, 628, 1617.530, 1817.530, 11.492, 0.250);

    // Adonis Bar
    RemoveBuildingForPlayer(playerid, 6975, 2167.590, 2425.590, 68.601, 0.250);
    ...
    RemoveBuildingForPlayer(playerid, 7530, 942.593, 1733.229, 13.281, 0.250);
    RemoveBuildingForPlayer(playerid, 7698, 942.593, 1733.229, 13.281, 0.250);
    ...
    //SUB DIVISION LIGHTHOUSE
    RemoveBuildingForPlayer(playerid, 6415, 154.210, -1950.195, 26.406, 0.250);
    RemoveBuildingForPlayer(playerid, 1461, 147.945, -1927.726, 3.554, 0.250);
    RemoveBuildingForPlayer(playerid, 6295, 154.210, -1950.195, 26.406, 0.250);
    RemoveBuildingForPlayer(playerid, 1461, 148.093, -1887.281, 3.546, 0.250);
    RemoveBuildingForPlayer(playerid, 1231, 154.453, -1887.242, 5.484, 0.250);
    RemoveBuildingForPlayer(playerid, 1280, 150.664, -1870.312, 3.101, 0.250);
    RemoveBuildingForPlayer(playerid, 1280, 158.664, -1908.320, 3.171, 0.250);
    RemoveBuildingForPlayer(playerid, 1461, 161.570, -1921.312, 3.539, 0.250);
    RemoveBuildingForPlayer(playerid, 1461, 161.656, -1893.640, 3.546, 0.250);
    RemoveBuildingForPlayer(playerid, 1461, 148.093, -1847.710, 3.546, 0.250);
    ...
    RemoveBuildingForPlayer(playerid, 1280, 159.195, -1842.585, 3.140, 0.250);
    ...
    RemoveBuildingForPlayer(playerid, 1461, 148.812, -1799.937, 3.539, 0.250);
    ...
    //casino - tamarah mappings v2
    RemoveBuildingForPlayer(playerid, 700, 1192.099, -1738.000, 13.039, 0.250);
    RemoveBuildingForPlayer(playerid, 647, 1192.099, -1733.020, 14.343, 0.250);
    RemoveBuildingForPlayer(playerid, 673, 1192.560, -1723.880, 12.523, 0.250);
    RemoveBuildingForPlayer(playerid, 647, 1198.319, -1724.589, 14.343, 0.250);
    RemoveBuildingForPlayer(playerid, 1215, 1207.800, -1722.770, 13.101, 0.250);
    RemoveBuildingForPlayer(playerid, 700, 1204.479, -1724.849, 13.039, 0.250);
    RemoveBuildingForPlayer(playerid, 673, 1250.979, -1723.880, 12.523, 0.250);
    RemoveBuildingForPlayer(playerid, 647, 1257.579, -1724.689, 14.343, 0.250);
    RemoveBuildingForPlayer(playerid, 700, 1263.979, -1724.849, 13.039, 0.250);
    RemoveBuildingForPlayer(playerid, 673, 1279.660, -1724.729, 12.523, 0.250);
    RemoveBuildingForPlayer(playerid, 647, 1284.979, -1761.170, 14.343, 0.250);
    RemoveBuildingForPlayer(playerid, 647, 1284.979, -1765.729, 14.343, 0.250);
    RemoveBuildingForPlayer(playerid, 1290, 1177.069, -1733.410, 18.578, 0.250);
    RemoveBuildingForPlayer(playerid, 647, 1284.979, -1796.900, 14.070, 0.250);
    RemoveBuildingForPlayer(playerid, 700, 1285.130, -1799.979, 13.039, 0.250);
    RemoveBuildingForPlayer(playerid, 620, 1286.300, -1808.609, 12.351, 0.250);
    RemoveBuildingForPlayer(playerid, 647, 1284.979, -1820.739, 14.070, 0.250);
    RemoveBuildingForPlayer(playerid, 673, 1284.890, -1823.859, 12.523, 0.250);
    RemoveBuildingForPlayer(playerid, 647, 1284.979, -1828.420, 14.070, 0.250);
    RemoveBuildingForPlayer(playerid, 673, 1256.229, -1839.979, 12.523, 0.250);
    RemoveBuildingForPlayer(playerid, 700, 1281.880, -1840.089, 13.039, 0.250);
    RemoveBuildingForPlayer(playerid, 647, 1284.979, -1839.810, 14.070, 0.250);
    RemoveBuildingForPlayer(playerid, 620, 1249.510, -1840.380, 12.351, 0.250);
    RemoveBuildingForPlayer(playerid, 647, 1244.500, -1839.810, 14.070, 0.250);
    RemoveBuildingForPlayer(playerid, 700, 1240.550, -1840.089, 13.039, 0.250);
    RemoveBuildingForPlayer(playerid, 647, 1235.839, -1839.810, 14.070, 0.250);
    RemoveBuildingForPlayer(playerid, 673, 1227.550, -1839.130, 12.523, 0.250);
    RemoveBuildingForPlayer(playerid, 673, 1200.880, -1839.130, 12.523, 0.250);
    RemoveBuildingForPlayer(playerid, 620, 1196.599, -1840.380, 12.351, 0.250);
    RemoveBuildingForPlayer(playerid, 647, 1192.829, -1839.810, 14.070, 0.250);
    RemoveBuildingForPlayer(playerid, 647, 1192.829, -1829.280, 14.070, 0.250);
    RemoveBuildingForPlayer(playerid, 673, 1192.619, -1826.949, 12.523, 0.250);

    //NEW OPEN INTERIOR HOUSE VERONA BEACH
    RemoveBuildingForPlayer(playerid, 726, 112.585, -1720.670, 8.078, 0.250);

    //farm map gasoline station
    RemoveBuildingForPlayer(playerid, 3276, -127.904, -1164.869, 2.726, 0.250);
    RemoveBuildingForPlayer(playerid, 3276, -139.117, -1161.088, 2.773, 0.250);
    RemoveBuildingForPlayer(playerid, 3276, -150.375, -1157.270, 2.217, 0.250);
    RemoveBuildingForPlayer(playerid, 3276, -161.070, -1153.739, 2.492, 0.250);
    RemoveBuildingForPlayer(playerid, 3276, -172.233, -1149.770, 3.960, 0.250);
    RemoveBuildingForPlayer(playerid, 3276, -182.953, -1146.290, 4.164, 0.250);
    RemoveBuildingForPlayer(playerid, 3276, -192.727, -1142.489, 3.789, 0.250);
    RemoveBuildingForPlayer(playerid, 3276, -203.617, -1138.750, 3.756, 0.250);
    RemoveBuildingForPlayer(playerid, 3276, -124.350, -1171.630, 2.726, 0.250);
    RemoveBuildingForPlayer(playerid, 3276, -128.710, -1181.229, 2.726, 0.250);
    RemoveBuildingForPlayer(playerid, 3276, -132.813, -1191.670, 2.726, 0.250);
    RemoveBuildingForPlayer(playerid, 3276, -136.358, -1201.670, 2.726, 0.250);
    RemoveBuildingForPlayer(playerid, 3276, -139.492, -1212.270, 2.726, 0.250);
    RemoveBuildingForPlayer(playerid, 3276, -142.516, -1223.160, 2.726, 0.250);
    RemoveBuildingForPlayer(playerid, 3276, -144.679, -1234.050, 2.726, 0.250);
    RemoveBuildingForPlayer(playerid, 3276, -147.375, -1245.198, 2.726, 0.250);
    RemoveBuildingForPlayer(playerid, 3276, -149.328, -1256.729, 2.726, 0.250);
    RemoveBuildingForPlayer(playerid, 3276, -151.179, -1268.348, 2.890, 0.250);
    RemoveBuildingForPlayer(playerid, 3276, -152.656, -1279.869, 2.890, 0.250);

    //HQ NI TAMARAHLABLAB
    RemoveBuildingForPlayer(playerid, 3173, -67.234, -1544.218, 1.554, 0.250);
    RemoveBuildingForPlayer(playerid, 1370, -64.000, -1550.260, 2.154, 0.250);
    RemoveBuildingForPlayer(playerid, 1438, -77.059, -1542.598, 1.616, 0.250);
    RemoveBuildingForPlayer(playerid, 3173, -90.638, -1562.937, 1.554, 0.250);
    RemoveBuildingForPlayer(playerid, 3175, -101.819, -1577.687, 1.406, 0.250);
    RemoveBuildingForPlayer(playerid, 1370, -100.819, -1580.420, 2.154, 0.250);
    RemoveBuildingForPlayer(playerid, 1457, -91.013, -1576.630, 3.194, 0.250);
    RemoveBuildingForPlayer(playerid, 1472, -75.583, -1581.067, 2.023, 0.250);
    RemoveBuildingForPlayer(playerid, 3175, -77.934, -1581.310, 1.406, 0.250);
    RemoveBuildingForPlayer(playerid, 1370, -74.184, -1583.989, 2.154, 0.250);
    RemoveBuildingForPlayer(playerid, 1438, -79.257, -1593.468, 1.500, 0.250);
    RemoveBuildingForPlayer(playerid, 1370, -86.569, -1595.140, 2.154, 0.250);
    RemoveBuildingForPlayer(playerid, 3174, -75.168, -1596.300, 1.679, 0.250);
    RemoveBuildingForPlayer(playerid, 1447, -74.819, -1607.260, 3.460, 0.250);
    ...
    RemoveBuildingForPlayer(playerid, 1370, -72.414, -1596.770, 2.154, 0.250);
    RemoveBuildingForPlayer(playerid, 1413, -53.812, -1585.859, 3.085, 0.250);
    RemoveBuildingForPlayer(playerid, 1447, -50.826, -1581.770, 3.164, 0.250);
    ...
    RemoveBuildingForPlayer(playerid, 1370, -43.742, -1563.687, 2.154, 0.250);
    RemoveBuildingForPlayer(playerid, 3174, -44.289, -1561.310, 1.679, 0.250);
    RemoveBuildingForPlayer(playerid, 727, -49.395, -1560.010, 1.460, 0.250);
    RemoveBuildingForPlayer(playerid, 3175, -55.278, -1557.447, 1.406, 0.250);
    RemoveBuildingForPlayer(playerid, 1370, -56.153, -1560.458, 2.154, 0.250);
    RemoveBuildingForPlayer(playerid, 1438, -93.208, -1569.479, 1.500, 0.250);
    RemoveBuildingForPlayer(playerid, 1438, -62.270, -1569.290, 1.500, 0.250);
    RemoveBuildingForPlayer(playerid, 3175, -64.382, -1572.208, 1.406, 0.250);
    RemoveBuildingForPlayer(playerid, 1370, -61.664, -1573.458, 2.154, 0.250);
    RemoveBuildingForPlayer(playerid, 1457, -71.000, -1574.088, 3.194, 0.250);
    RemoveBuildingForPlayer(playerid, 727, -73.819, -1569.170, 1.350, 0.250);
    RemoveBuildingForPlayer(playerid, 1462, -93.679, -1588.078, 1.506, 0.250);
    RemoveBuildingForPlayer(playerid, 3173, -93.093, -1593.520, 1.554, 0.250);
    RemoveBuildingForPlayer(playerid, 1438, -88.109, -1598.718, 1.500, 0.250);
    RemoveBuildingForPlayer(playerid, 1438, -56.062, -1575.660, 1.500, 0.250);

    //BAHAY NI TAMARAHLABLAB
    RemoveBuildingForPlayer(playerid, 730, 93.781, -1639.560, 8.820, 0.250);
    RemoveBuildingForPlayer(playerid, 1280, 86.937, -1647.640, 10.492, 0.250);

    //YOHAN'S DONATE HOUSE
    RemoveBuildingForPlayer(playerid, 3604, 169.296, -1332.338, 71.593, 0.250);
    RemoveBuildingForPlayer(playerid, 3737, 169.296, -1332.338, 71.593, 0.250);
    RemoveBuildingForPlayer(playerid, 762, 209.554, -1318.489, 74.600, 0.250);
    RemoveBuildingForPlayer(playerid, 762, 212.772, -1327.968, 74.139, 0.250);
    RemoveBuildingForPlayer(playerid, 700, 205.641, -1308.640, 71.975, 0.250);
    RemoveBuildingForPlayer(playerid, 671, 180.320, -1277.818, 69.757, 0.250);
    RemoveBuildingForPlayer(playerid, 671, 160.070, -1283.328, 69.319, 0.250);
    ...
    RemoveBuildingForPlayer(playerid, 620, 191.016, -1280.729, 72.061, 0.250);
    RemoveBuildingForPlayer(playerid, 620, 195.953, -1281.229, 72.750, 0.250);
    RemoveBuildingForPlayer(playerid, 673, 196.375, -1284.938, 73.414, 0.250);
    RemoveBuildingForPlayer(playerid, 700, 216.156, -1343.910, 50.467, 0.250);
    RemoveBuildingForPlayer(playerid, 700, 198.757, -1330.290, 68.429, 0.250);
    RemoveBuildingForPlayer(playerid, 671, 497.703, -1162.739, 62.429, 0.250);
    RemoveBuildingForPlayer(playerid, 673, 200.375, -1292.310, 73.593, 0.250);

    //tam donate 200
    RemoveBuildingForPlayer(playerid, 3361, -796.460, 2245.877, 55.601, 0.250);
    RemoveBuildingForPlayer(playerid, 1365, 861.984, -1380.458, 13.625, 0.250);
    RemoveBuildingForPlayer(playerid, 1440, 857.375, -1381.160, 13.045, 0.250);
    RemoveBuildingForPlayer(playerid, 5817, 848.859, -1370.430, 17.795, 0.250);
    RemoveBuildingForPlayer(playerid, 1635, 860.914, -1359.800, 16.083, 0.250);
    RemoveBuildingForPlayer(playerid, 1462, 853.195, -1359.729, 12.553, 0.250);
    RemoveBuildingForPlayer(playerid, 620, 268.523, -1189.697, 78.169, 0.250);
    RemoveBuildingForPlayer(playerid, 700, 274.195, -1202.328, 79.734, 0.250);
    RemoveBuildingForPlayer(playerid, 3619, 249.046, -1370.989, 55.742, 0.250);
    RemoveBuildingForPlayer(playerid, 3738, 249.046, -1370.989, 55.742, 0.250);
    RemoveBuildingForPlayer(playerid, 708, 287.953, -1206.729, 79.289, 0.250);
    RemoveBuildingForPlayer(playerid, 706, 252.906, -1156.197, 77.763, 0.250);
    RemoveBuildingForPlayer(playerid, 762, 245.156, -1160.280, 81.804, 0.250);
    RemoveBuildingForPlayer(playerid, 669, 275.289, -1374.839, 51.882, 0.250);
    RemoveBuildingForPlayer(playerid, 673, 258.296, -1391.400, 51.664, 0.250);
    RemoveBuildingForPlayer(playerid, 673, 244.031, -1387.209, 51.796, 0.250);
    RemoveBuildingForPlayer(playerid, 669, 246.406, -1399.219, 51.765, 0.250);
    RemoveBuildingForPlayer(playerid, 673, 230.227, -1379.209, 51.546, 0.250);
    RemoveBuildingForPlayer(playerid, 673, 228.438, -1368.750, 51.859, 0.250);
    RemoveBuildingForPlayer(playerid, 671, 256.421, -1350.390, 51.968, 0.250);
    RemoveBuildingForPlayer(playerid, 669, 273.812, -1344.180, 52.500, 0.250);
    RemoveBuildingForPlayer(playerid, 620, 280.679, -1347.310, 50.328, 0.250);
    RemoveBuildingForPlayer(playerid, 671, 270.804, -1349.310, 52.156, 0.250);
    RemoveBuildingForPlayer(playerid, 669, 269.500, -1354.540, 52.242, 0.250);
    RemoveBuildingForPlayer(playerid, 620, 272.117, -1361.410, 50.804, 0.250);
    RemoveBuildingForPlayer(playerid, 708, 286.000, -1362.390, 51.820, 0.250);
    RemoveBuildingForPlayer(playerid, 762, 287.273, -1362.099, 56.109, 0.250);
    RemoveBuildingForPlayer(playerid, 700, 223.266, -1369.089, 52.343, 0.250);
    RemoveBuildingForPlayer(playerid, 700, 219.328, -1371.650, 52.054, 0.250);
    RemoveBuildingForPlayer(playerid, 669, 217.703, -1381.609, 52.171, 0.250);
    RemoveBuildingForPlayer(playerid, 669, 209.750, -1381.449, 52.140, 0.250);
    RemoveBuildingForPlayer(playerid, 620, 217.852, -1374.689, 51.148, 0.250);
    RemoveBuildingForPlayer(playerid, 620, 241.195, -1395.030, 51.492, 0.250);
    RemoveBuildingForPlayer(playerid, 669, 230.125, -1390.839, 51.921, 0.250);
    RemoveBuildingForPlayer(playerid, 620, 242.016, -1405.609, 51.296, 0.250);
    RemoveBuildingForPlayer(playerid, 620, 238.016, -1354.949, 50.992, 0.250);
    ...
    //gate na ginawa ni tamarah
    RemoveBuildingForPlayer(playerid, 716, 1338.510, -1058.520, 25.875, 0.250);
    RemoveBuildingForPlayer(playerid, 727, 1334.160, -1051.369, 26.125, 0.250);
    RemoveBuildingForPlayer(playerid, 1408, 944.218, -831.367, 94.773, 0.250);
    RemoveBuildingForPlayer(playerid, 1408, 949.140, -828.679, 95.140, 0.250);
    RemoveBuildingForPlayer(playerid, 1307, 947.937, -830.546, 94.453, 0.250);

    //aiana donated house border
    ...
    //VLADIMIR
    RemoveBuildingForPlayer(playerid, 710, 1086.369, -778.156, 120.609, 0.250);
    RemoveBuildingForPlayer(playerid, 1409, 1071.050, -778.476, 106.289, 0.250);
    RemoveBuildingForPlayer(playerid, 1409, 1072.140, -778.382, 106.444, 0.250);

    //MODERN HOUSE WITH POOL
    RemoveBuildingForPlayer(playerid, 6237, 726.500, -1658.619, 9.750, 0.250);
    RemoveBuildingForPlayer(playerid, 759, 763.148, -1598.140, 12.070, 0.250);
    RemoveBuildingForPlayer(playerid, 759, 765.312, -1598.439, 12.070, 0.250);
    ...
    RemoveBuildingForPlayer(playerid, 759, 775.296, -1598.050, 12.296, 0.250);
    RemoveBuildingForPlayer(playerid, 1408, 777.695, -1596.640, 13.078, 0.250);
    RemoveBuildingForPlayer(playerid, 759, 777.875, -1598.050, 12.296, 0.250);
    RemoveBuildingForPlayer(playerid, 759, 777.437, -1599.839, 12.296, 0.250);
    RemoveBuildingForPlayer(playerid, 759, 776.343, -1602.969, 12.554, 0.250);
    RemoveBuildingForPlayer(playerid, 730, 776.679, -1617.130, 11.859, 0.250);
    RemoveBuildingForPlayer(playerid, 759, 761.289, -1625.150, 12.554, 0.250);
    RemoveBuildingForPlayer(playerid, 730, 765.546, -1619.910, 11.859, 0.250);
    RemoveBuildingForPlayer(playerid, 762, 771.914, -1621.520, 14.781, 0.250);
    RemoveBuildingForPlayer(playerid, 1408, 761.757, -1605.739, 12.960, 0.250);
    RemoveBuildingForPlayer(playerid, 3639, 770.343, -1606.410, 16.203, 0.250);
    RemoveBuildingForPlayer(playerid, 3718, 770.343, -1606.410, 16.203, 0.250);
    ...
    RemoveBuildingForPlayer(playerid, 621, 765.335, -1644.520, 2.234, 0.250);
    RemoveBuildingForPlayer(playerid, 759, 765.328, -1642.790, 2.898, 0.250);
    RemoveBuildingForPlayer(playerid, 762, 771.914, -1641.760, 5.890, 0.250);
    RemoveBuildingForPlayer(playerid, 620, 774.695, -1634.010, 0.039, 0.250);
    RemoveBuildingForPlayer(playerid, 762, 768.421, -1632.729, 9.156, 0.250);
    ...
    RemoveBuildingForPlayer(playerid, 759, 506.296, -1219.819, 43.109, 0.250);
    ...
    RemoveBuildingForPlayer(playerid, 1307, 1983.339, -1557.680, 12.664, 0.250);
    RemoveBuildingForPlayer(playerid, 1308, 1979.770, -1614.939, 12.781, 0.250);
    ...
    RemoveBuildingForPlayer(playerid, 620, 2322.5547, -1580.1016, 14.5000, 0.25);
    ...
    RemoveBuildingForPlayer(playerid, 620, 2365.1797, -1580.1016, 15.7188, 0.25);
